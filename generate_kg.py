...
def gen_kg(tag, url_file_path = None, file_path = None, file_state = False, url_state = False):
    ...
    if file_state:
        ...
        if len(file_content) > 90:
            batch_size = 90
            kg = from_text_to_kg(file_content[0:90], verbose=True)
            for i in range(90, len(file_content), batch_size):
...
if __name__ == '__main__':
    ...
    gen_kg('BRAIN', file_path = 'fetched_data/BRAIN_dataset.csv', file_state = True)  
