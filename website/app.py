...
def main():
    st.set_page_config(page_title="Research Assistant", page_icon=":books:", layout="wide")
    ...
    if st.button("Generate KG"):
        ...
        if uploaded_file or url:
            ...
            if url:
                gkg.gen_kg(tag, file_path = f'../fetched_data/{tag}_dataset.csv', url_state = True)
